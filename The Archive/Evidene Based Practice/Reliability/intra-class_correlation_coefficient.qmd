...
$$ ICC = \frac{\sigma_s^2}{\sigma_s^2 + \sigma_e^2} = \frac{\sigma_s^2}{\sigma_Total^2}$$
...
$$
ICC = \frac{(Variance of Interest)}{(Variance of Interest) + (Unwanted Variance)} = \frac{(5)}{(5) + (6)} = \frac{5}{11} = 0.455
$$
