...
Kriffindorf's alpha is a modified [Kappa coefficient]({{< var ref-kappa-coefficient.path >}}) that is a measure of agreement, which is even more flexible than Fleiss’ Kappa @zapfMeasuringInterraterReliability2016.
...
# Use
For nominal data with no missing values both [Fleiss’ Kappa]({{< var ref-fleiss-kappa.path >}}) and Krippendorff’s alpha can be recommended


Kriffindorf's Alpha can be used for two or more raters and categories, and it is not only applicable for nominal data, but for any measurement scale, including metric data @zapfMeasuringInterraterReliability2016
