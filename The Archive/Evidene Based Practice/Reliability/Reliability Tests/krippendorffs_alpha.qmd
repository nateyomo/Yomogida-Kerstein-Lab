...
Krippendorff's Alpha is a modified [Kappa coefficient]({{< var ref-kappa-coefficient.path >}}) that is a measure of agreement, which is even more flexible than Fleiss’ Kappa @zapfMeasuringInterraterReliability2016.
