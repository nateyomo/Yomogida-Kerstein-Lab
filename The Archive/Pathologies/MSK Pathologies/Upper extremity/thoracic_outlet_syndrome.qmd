...
- Conservative measures shld be attempted for pt w/ disputed neuro TOS before surgery is considered
- Recent SR found good to very good results achieved in 76-100% of disputed neuro TOS pts at short term follow up and 59-88% in a year at least
- If there are objective findings of nerve compression, it is called a true neurogenic TOS[6]. However, when there is no specific pathological evidence of TOS, it is classified as disputed TOS.
...
- NSAIDs
- Botulinum toxin (ant to middle scalenes)
- 64% of subjects had a min 50% decrease in pain, numbness, fatigue for at least one month following injection
- Traction could help 
- If pain is position dependent, avoid provocative position during night 
- Place pillows between arm and body w/ side lying or place under each arm when lying supine
- Cyriax release technique
    - Fully unload neurovascular structures in thoracic outlet prior to sleeping at night, which will allow the pt to sleep thru the night without waking
- Pt should remain in this position as long as can be tolerated (preferably until the symptoms are appreciably resolved) in order to completely unload the thoracic outlet
